...
}else if (player1 === "Tesoura" && player2 === "Tesoura" || player1 === "Pedra" && player2 === "Pedra"){
    return "Empate!"
}
...
if(player1 === "Tesoura" && player2 === "Papel"){
    ...
    return "Jogador 2 venceu!"
}else if (player1 === "Papel" && player2 === "Papel" || player1 === "Tesoura" && player2 === "Tesoura"){
    return "Empate!"
}
...
if(player1 === "Papel" && player2 === "Pedra"){
    ...
    return "Jogador 2 venceu!"
}else if (player1 === "Papel" && player2 === "Papel" || player1 === "Pedra" && player2 === "Pedra"){
    return "Empate!"
}
